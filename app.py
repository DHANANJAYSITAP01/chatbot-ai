...
# ---------------- API SETUP ----------------
client = Groq(
    api_key="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"  # ⚠️ इथे तुमची खरी Groq API Key टाका
)
...
st.markdown("""
<style>
/* सर्व पांढरे भाग आणि डिफॉल्ट बॉर्डर्स मुळापासून नष्ट करणे */
...
/* ➕ प्लस ड्रॉपडाउन मेनू (PRACTICAL FILES MENUS) */
.plus-dropdown-menu {
    display: none;
    position: absolute;
    bottom: 45px;
...
/* ड्रॉपडाउनमधील लेबल जे अदृश्य अपलोडरला ट्रिगर करेल */
...
# ---------------- 🎯 THE CAPSULE BAR WITH DYNAMIC UPLOAD MENU ----------------
# इथे आपण साध्या <a> टॅग्ज ऐवजी <label> टॅग वापरले आहेत जे क्लिक केल्यावर कॉम्प्युटरचे फाईल सिलेक्टर्स उघडतील.
st.markdown("""
...
# --- 🛑 गुप्त फाईल अपलोडर घटक (हे स्क्रीनवर दिसणार नाहीत पण मागे काम करतील) ---
# हे घटक वरच्या HTML लेबल्सवर क्लिक करताच आपोआप ट्रिगर होतीar!
with st.sidebar:
...
# १. आधी तपासूया की युझरने एखादी फाईल अपलोड केली आहे का
if uploaded_photo:
